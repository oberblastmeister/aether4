       ...
       ((ty (Int 2:3-6)) (name main@0) (params ())
        (body
         ((Declare (ty (Int 3:13-16)) (var tmp@1) (span 3:13-26))
          (Assign (lvalue (Lvalue_var (var tmp@1) (ty ())))
           (expr (Int_const ((t 0) (span 3:25)))) (span 3:13-26))
          (Declare (ty (Int 3:13-16)) (var first@0) (span 3:13-26))
          (Assign (lvalue (Lvalue_var (var first@0) (ty ())))
           (expr (Var (var tmp@1) (ty ()))) (span 3:13-26))
          (Declare (ty (Int 4:13-16)) (var tmp@3) (span 4:13-30))
          (Assign (lvalue (Lvalue_var (var tmp@3) (ty ())))
           (expr (Int_const ((t 1234) (span 4:26-30)))) (span 4:13-30))
          (Declare (ty (Int 4:13-16)) (var second@2) (span 4:13-30))
          (Assign (lvalue (Lvalue_var (var second@2) (ty ())))
           (expr (Var (var tmp@3) (ty ()))) (span 4:13-30))
          (Declare (ty (Bool 5:13-17)) (var tmp@5) (span 5:13-30))
          (Assign (lvalue (Lvalue_var (var tmp@5) (ty ())))
           (expr (Bool_const ((t true) (span 5:26-30)))) (span 5:13-30))
          (Declare (ty (Bool 5:13-17)) (var third@4) (span 5:13-30))
          (Assign (lvalue (Lvalue_var (var third@4) (ty ())))
           (expr (Var (var tmp@5) (ty ()))) (span 5:13-30))
          (Return
           (expr
