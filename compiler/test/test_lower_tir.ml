         ...
         (body
          (((i (Block_params (temps ()))) (index 0) (info ()))
           ...
           ((i (Unary (dst rhs@5) (op (Copy Int)) (src third@6))) (index 2)
            (info ()))
           ((i (Bin (dst first@1) (op Add) (src1 lhs@4) (src2 rhs@5))) (index 3)
            (info ()))
        ...
        ((label start@3)
         (body
          (((i (Block_params (temps ()))) (index 0) (info ()))
           ...
           ((i (Nullary (dst tmp@15) (op (Int_const 1342)))) (index 2) (info ()))
           ((i (Unary (dst first@1) (op (Copy Int)) (src tmp@15))) (index 3)
            (info ()))
           ((i (Nullary (dst tmp@14) (op (Int_const 1234)))) (index 4) (info ()))
           ...
           ((i (Unary (dst rhs@12) (op (Copy Int)) (src second@13))) (index 7)
            (info ()))
           ((i (Bin (dst tmp@10) (op Add) (src1 lhs@11) (src2 rhs@12))) (index 8)
            (info ()))
           ...
           ((i (Unary (dst bl@7) (op (Copy Bool)) (src tmp@8))) (index 13)
            (info ()))
           ((i (Unary (dst cond@2) (op (Copy Bool)) (src another@3))) (index 14)
            (info ()))
           ((i
       ...
       (start@3
        ((label start@3)
         (body
          (((i (Block_params (temps ()))) (index 0) (info ()))
           ((i (Block_params (temps ()))) (index 1) (info ()))
           ((i (Nullary (dst tmp@11) (op (Int_const 1342)))) (index 2) (info ()))
           ((i (Unary (dst first@4) (op (Copy Int)) (src tmp@11))) (index 3)
            (info ()))
           ((i (Nullary (dst tmp@10) (op (Int_const 1234)))) (index 4) (info ()))
           ...
           ((i (Unary (dst another@3) (op (Copy Bool)) (src tmp@5))) (index 11)
            (info ()))
           ((i (Unary (dst cond@2) (op (Copy Bool)) (src another@3))) (index 12)
            (info ()))
           ((i
             (Cond_jump (cond cond@2) (b1 ((label then@1) (args ())))
              (b2 ((label else@2) (args ())))))
