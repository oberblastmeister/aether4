         ...
         (body
          (((i (Block_params (((param first@17) (ty Int))))) (index 0)
           ...
           ((i (Unary (dst ret@18) (op (Copy Int)) (src first@17))) (index 1)
            (info (3:19-24)) (ann ()))
           ((i (Ret (src ret@18) (ty Int))) (index 2) (info (13:15-27)) (ann ()))
         ...
         (body
          (((i (Block_params ())) (index 0) (info ([2,7]-[14,12])) (ann ()))
           ...
           ((i (Nullary (dst tmp@8) (op (Bool_const true)))) (index 9)
            (info (6:30-34)) (ann ()))
           ((i (Unary (dst another@9) (op (Copy Bool)) (src tmp@8))) (index 10)
            (info (6:20-27)) (ann ()))
           ((i (Nullary (dst tmp@10) (op (Bool_const false)))) (index 11)
            (info (7:25-30)) (ann ()))
           ((i (Unary (dst bl@11) (op (Copy Bool)) (src tmp@10))) (index 12)
            (info (7:20-22)) (ann ()))
           ((i (Unary (dst cond@12) (op (Copy Bool)) (src another@9))) (index 13)
            (info (6:20-27)) (ann ()))
           ((i
         ...
         (body
          (((i (Block_params ())) (index 0) (info ([7,7]-[11,8])) (ann ()))
           ((i (Unary (dst ret@13) (op (Copy Int)) (src third@7))) (index 1)
            (info (5:11-16)) (ann ()))
           ((i (Ret (src ret@13) (ty Int))) (index 2) (info (12:7-19)) (ann ()))
         ...
         (body
          (((i (Block_params ())) (index 0) (info ([7,7]-[11,8])) (ann ()))
           ((i (Nullary (dst first@12) (op (Int_const 1)))) (index 1)
            (info (8:17)) (ann ()))
           ((i (Jump ((label join@0) (args ())))) (index 2) (info ([7,7]-[11,8]))
            (ann ()))
           ((i Unreachable) (index 3) (info ([7,7]-[11,8])) (ann ()))))))
       (else@2
        ((label else@2)
        ...
        ((label start@3)
         (body
          (((i (Block_params ())) (index 0) (info ([2,5]-[13,6])) (ann ()))
           ...
           ((i (Unary (dst another@9) (op (Copy Bool)) (src tmp@8))) (index 10)
            (info (6:12-19)) (ann ()))
           ((i (Unary (dst cond@10) (op (Copy Bool)) (src another@9))) (index 11)
            (info (6:12-19)) (ann ()))
           ((i
