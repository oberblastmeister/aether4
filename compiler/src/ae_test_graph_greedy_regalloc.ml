...
let%test_module _ =
  (module struct
    ...
    let%expect_test "simple no conflicts" =
      ...
      print_s [%message (res : Color.t Vreg.Table.t)];
      ();
      [%expect {| (res ((first@0 0) (second@1 0) (third@2 0))) |}]
    ;;
    ...
    let%expect_test "simple conflicts" =
      ...
      print_s [%message (res : Color.t Vreg.Table.t)];
      ();
      [%expect {| (res ((first@0 1) (second@1 0) (third@2 0))) |}]
    ;;
    ...
    let%expect_test "simple conflicts 2" =
      ...
      let res = Regalloc.color_graph graph Name.Set.empty in
      print_s [%message (res : Color.t Vreg.Table.t)];
      [%expect {| (res ((first@0 2) (second@1 1) (third@2 0) (fourth@3 0))) |}]
    ;;
  end)
;;
